...
this allows us to install the package to create vignettes
...
this allows us to display the vignette
...
this allows us to zoom into the plot 
...
this allows us to set limits on individual scales (it can be seen as viewing a subset of the data)
...
this allows us to spread plots over many pages 
...
this allows us to include themes

```{r} 
ggplot(mpg, aes(displ, hwy)) + geom_point()
```

this allows us to save the plot 